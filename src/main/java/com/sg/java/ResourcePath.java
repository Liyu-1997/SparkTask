...
public class ResourcePath {
    ...
    public static final String kafka_spark_streaming_hbase_properties = "kafka.spark-streaming.hbase.properties";

    public static final String kafka_producer_properties = "kafka-producer.properties";
